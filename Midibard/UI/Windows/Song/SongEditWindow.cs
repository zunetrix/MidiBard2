...
public class SongEditWindow : Window
{
    ...
    private readonly ImGuiComboSearch _addTagCombo = new();
    ...
    private void DrawEditForm()
    {
        ...
        if (ImGui.InputInt("##EditSongYear", ref _editState.EditReleaseYear, 1, 1, flags: ImGuiInputTextFlags.AutoSelectAll))
        {
        ...
        if (_editState.AvailableTags.Count > 0)
        {
            ...
            if (_addTagCombo.Draw("##EditSongAddTagCombo", tagNames, ref selectedTag, 10))
            {
