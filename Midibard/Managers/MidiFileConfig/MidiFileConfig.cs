...
internal class MidiFileConfig
{
    ...
    /// <summary>Per-song instrument delay compensation values (ms). Key = instrument rowId. When set, overrides the global InstrumentCompensationOverrides and switches mode to ByInstrument.</summary>
